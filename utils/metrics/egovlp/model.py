...
class FrozenInTime(BaseModel):
    def __init__(self,
        ...
        if self.text_params['model'].startswith('distilbert'):
            ...
            self.text_model = AutoModel.from_pretrained('distilbert-base-uncased', cache_dir='/simurgh2/projects/Mask2IV/checkpoints/egovlp/distilbert-base-uncased')
        else:
        ...
        if video_params['model'] == "SpaceTimeTransformer":
            ...
            if arch_config == 'base_patch16_224':
                ...
                vit_model = torch.load("/simurgh2/projects/Mask2IV/checkpoints/egovlp/jx_vit_base_p16_224-80ecf9dd.pth", map_location="cpu")
        ...
        if load_checkpoint not in ["", None]:
            checkpoint = torch.load(load_checkpoint, weights_only=False)  # for debug -- add by Bolin, the original codes are for multi-gpu loading
